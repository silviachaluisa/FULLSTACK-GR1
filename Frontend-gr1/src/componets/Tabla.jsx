...
import { MdDeleteForever,MdNoteAdd,MdInfo, MdNavigateBefore } from "react-icons/md";
...
const Tabla = () => {
    ...
    //Solo para que se ejecute un sola vez
    useEffect(() => {
        listarPacientes()
    }, [])
    return (
        //Para que se vea en lista el nomvbre de los pacientes registrados
        // <ul>
        //     {pacientes.map(paciente=><li key={paciente._id}>{paciente.nombre} </li>)} 
        // </ul>   
        <>
        {
            pacientes.length == 0
